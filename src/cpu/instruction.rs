...
impl Instruction {
    pub fn execute (&self, cpu: &mut Cpu, memory: &mut Memory) -> u8 {
        let operand = match self.mode {
            ...
            AddressingMode::Accumulator => Operand::Byte(cpu.a),
...
pub const INSTRUCTIONS: [Instruction; 256] = [
    ...
    Instruction { opcode: 0x01, name: "ORA", mode: AddressingMode::IndirectX,   cycles: 2, handler: unimplemented,  illegal: false  },
    ...
    Instruction { opcode: 0x05, name: "ORA", mode: AddressingMode::ZeroPage,    cycles: 2, handler: unimplemented,  illegal: false  },
    Instruction { opcode: 0x06, name: "ASL", mode: AddressingMode::ZeroPage,    cycles: 2, handler: unimplemented,  illegal: false  },
    ...
    Instruction { opcode: 0x09, name: "ORA", mode: AddressingMode::Immediate,   cycles: 2, handler: unimplemented,  illegal: false  },
    Instruction { opcode: 0x0A, name: "ASL", mode: AddressingMode::Absolute,    cycles: 2, handler: unimplemented,  illegal: false  },
    ...
    Instruction { opcode: 0x0D, name: "ORA", mode: AddressingMode::Absolute,    cycles: 2, handler: unimplemented,  illegal: false  },
    Instruction { opcode: 0x0E, name: "ASL", mode: AddressingMode::Absolute,    cycles: 2, handler: unimplemented,  illegal: false  },
    ...
    Instruction { opcode: 0x11, name: "ORA", mode: AddressingMode::IndirectY,   cycles: 2, handler: unimplemented,  illegal: false  },
    ...
    Instruction { opcode: 0x15, name: "ORA", mode: AddressingMode::ZeroPageX,   cycles: 2, handler: unimplemented,  illegal: false  },
    Instruction { opcode: 0x16, name: "ASL", mode: AddressingMode::ZeroPageX,   cycles: 2, handler: unimplemented,  illegal: false  },
    ...
    Instruction { opcode: 0x19, name: "ORA", mode: AddressingMode::AbsoluteY,   cycles: 2, handler: unimplemented,  illegal: false  },
    ...
    Instruction { opcode: 0x1D, name: "ORA", mode: AddressingMode::AbsoluteX,   cycles: 2, handler: unimplemented,  illegal: false  },
    Instruction { opcode: 0x1E, name: "ASL", mode: AddressingMode::AbsoluteX,   cycles: 2, handler: unimplemented,  illegal: false  },
    ...
    Instruction { opcode: 0x26, name: "ROL", mode: AddressingMode::ZeroPage,    cycles: 2, handler: unimplemented,  illegal: false  },
    ...
    Instruction { opcode: 0x2A, name: "ROL", mode: AddressingMode::Accumulator, cycles: 2, handler: unimplemented,  illegal: false  },
    ...
    Instruction { opcode: 0x2E, name: "ROL", mode: AddressingMode::Absolute,    cycles: 2, handler: unimplemented,  illegal: false  },
    Instruction { opcode: 0x2F, name: "", mode: AddressingMode::Implied,        cycles: 2, handler: unimplemented,  illegal: true   },

    Instruction { opcode: 0x30, name: "BMI", mode: AddressingMode::Relative,    cycles: 2, handler: unimplemented,  illegal: false  },
    ...
    Instruction { opcode: 0x36, name: "ROL", mode: AddressingMode::ZeroPageX,   cycles: 2, handler: unimplemented,  illegal: false  },
    ...
    Instruction { opcode: 0x3E, name: "ROL", mode: AddressingMode::AbsoluteX,   cycles: 2, handler: unimplemented,  illegal: false  },
    Instruction { opcode: 0x3F, name: "RLA", mode: AddressingMode::AbsoluteX,   cycles: 2, handler: unimplemented,  illegal: true   },

    Instruction { opcode: 0x40, name: "RTI", mode: AddressingMode::Implied,     cycles: 6, handler: unimplemented,  illegal: false  },
    Instruction { opcode: 0x41, name: "EOR", mode: AddressingMode::IndirectX,   cycles: 2, handler: unimplemented,  illegal: false  },
    ...
    Instruction { opcode: 0x45, name: "EOR", mode: AddressingMode::ZeroPage,    cycles: 2, handler: unimplemented,  illegal: false  },
    ...
    Instruction { opcode: 0x49, name: "EOR", mode: AddressingMode::Immediate,   cycles: 2, handler: unimplemented,  illegal: false  },
    ...
    Instruction { opcode: 0x4D, name: "EOR", mode: AddressingMode::Absolute,    cycles: 2, handler: unimplemented,  illegal: false  },
    ...
    Instruction { opcode: 0x51, name: "EOR", mode: AddressingMode::IndirectY,   cycles: 2, handler: unimplemented,  illegal: false  },
    ...
    Instruction { opcode: 0x55, name: "EOR", mode: AddressingMode::ZeroPageX,   cycles: 2, handler: unimplemented,  illegal: false  },
    ...
    Instruction { opcode: 0x59, name: "EOR", mode: AddressingMode::AbsoluteY,   cycles: 2, handler: unimplemented,  illegal: false  },
    ...
    Instruction { opcode: 0x5D, name: "EOR", mode: AddressingMode::AbsoluteX,   cycles: 2, handler: unimplemented,  illegal: false  },
    ...
    Instruction { opcode: 0x61, name: "ADC", mode: AddressingMode::IndirectX,   cycles: 2, handler: unimplemented,  illegal: false  },
    ...
    Instruction { opcode: 0x65, name: "ADC", mode: AddressingMode::ZeroPage,    cycles: 2, handler: unimplemented,  illegal: false  },
    Instruction { opcode: 0x66, name: "ROR", mode: AddressingMode::ZeroPage,    cycles: 2, handler: unimplemented,  illegal: false  },
    Instruction { opcode: 0x67, name: "", mode: AddressingMode::Implied,        cycles: 2, handler: unimplemented,  illegal: true   },
    Instruction { opcode: 0x68, name: "PLA", mode: AddressingMode::Implied,     cycles: 2, handler: pla,            illegal: false  },
    Instruction { opcode: 0x69, name: "ADC", mode: AddressingMode::Immediate,   cycles: 2, handler: adc,            illegal: false  },
    Instruction { opcode: 0x6A, name: "ROR", mode: AddressingMode::Accumulator, cycles: 2, handler: unimplemented,  illegal: false  },
    ...
    Instruction { opcode: 0x6D, name: "ADC", mode: AddressingMode::Absolute,    cycles: 2, handler: unimplemented,  illegal: false  },
    Instruction { opcode: 0x6E, name: "ROR", mode: AddressingMode::Absolute,    cycles: 2, handler: unimplemented,  illegal: false  },
    ...
    Instruction { opcode: 0x71, name: "ADC", mode: AddressingMode::IndirectY,   cycles: 2, handler: unimplemented,  illegal: false  },
    ...
    Instruction { opcode: 0x75, name: "ADC", mode: AddressingMode::ZeroPageX,   cycles: 2, handler: unimplemented,  illegal: false  },
    Instruction { opcode: 0x76, name: "ROR", mode: AddressingMode::ZeroPageX,   cycles: 2, handler: unimplemented,  illegal: false  },
    ...
    Instruction { opcode: 0x79, name: "ADC", mode: AddressingMode::AbsoluteY,   cycles: 2, handler: unimplemented,  illegal: false  },
    ...
    Instruction { opcode: 0x7D, name: "ADC", mode: AddressingMode::AbsoluteX,   cycles: 2, handler: unimplemented,  illegal: false  },
    Instruction { opcode: 0x7E, name: "ROR", mode: AddressingMode::AbsoluteX,   cycles: 2, handler: unimplemented,  illegal: false  },
    ...
    Instruction { opcode: 0x81, name: "STA", mode: AddressingMode::IndirectX,   cycles: 2, handler: unimplemented,  illegal: false  },
    ...
    Instruction { opcode: 0x88, name: "DEY", mode: AddressingMode::Implied,     cycles: 2, handler: unimplemented,  illegal: false  },
    Instruction { opcode: 0x89, name: "", mode: AddressingMode::Implied,        cycles: 2, handler: unimplemented,  illegal: true   },
    Instruction { opcode: 0x8A, name: "TXA", mode: AddressingMode::Implied,     cycles: 2, handler: unimplemented,  illegal: false  },
    ...
    Instruction { opcode: 0x8D, name: "STA", mode: AddressingMode::Absolute,    cycles: 2, handler: unimplemented,  illegal: false  },
    ...
    Instruction { opcode: 0x91, name: "STA", mode: AddressingMode::IndirectY,   cycles: 2, handler: unimplemented,  illegal: false  },
    ...
    Instruction { opcode: 0x95, name: "STA", mode: AddressingMode::ZeroPageX,   cycles: 2, handler: unimplemented,  illegal: false  },
    ...
    Instruction { opcode: 0x98, name: "TYA", mode: AddressingMode::Implied,     cycles: 2, handler: unimplemented,  illegal: false  },
    Instruction { opcode: 0x99, name: "STA", mode: AddressingMode::AbsoluteY,   cycles: 2, handler: sta,            illegal: false  },
    Instruction { opcode: 0x9A, name: "TXS", mode: AddressingMode::Implied,     cycles: 2, handler: unimplemented,  illegal: false  },
    ...
    Instruction { opcode: 0xA0, name: "LDY", mode: AddressingMode::Immediate,   cycles: 2, handler: unimplemented,  illegal: false  },
    ...
    Instruction { opcode: 0xA4, name: "LDY", mode: AddressingMode::ZeroPage,    cycles: 2, handler: unimplemented,  illegal: false  },
    Instruction { opcode: 0xA5, name: "LDA", mode: AddressingMode::ZeroPage,    cycles: 2, handler: unimplemented,  illegal: false  },
    ...
    Instruction { opcode: 0xA8, name: "TAY", mode: AddressingMode::Implied,     cycles: 2, handler: unimplemented,  illegal: false  },
    ...
    Instruction { opcode: 0xAC, name: "LDY", mode: AddressingMode::Absolute,    cycles: 2, handler: unimplemented,  illegal: false  },
    Instruction { opcode: 0xAD, name: "LDA", mode: AddressingMode::Absolute,    cycles: 2, handler: unimplemented,  illegal: false  },
    ...
    Instruction { opcode: 0xB1, name: "LDA", mode: AddressingMode::IndirectY,   cycles: 2, handler: unimplemented,  illegal: false  },
    ...
    Instruction { opcode: 0xB4, name: "LDY", mode: AddressingMode::ZeroPageX,   cycles: 2, handler: unimplemented,  illegal: false  },
    Instruction { opcode: 0xB5, name: "LDA", mode: AddressingMode::ZeroPageX,   cycles: 2, handler: unimplemented,  illegal: false  },
    ...
    Instruction { opcode: 0xB8, name: "CLV", mode: AddressingMode::Implied,     cycles: 2, handler: unimplemented,  illegal: false  },
    Instruction { opcode: 0xB9, name: "LDA", mode: AddressingMode::AbsoluteY,   cycles: 2, handler: unimplemented,  illegal: false  },
    Instruction { opcode: 0xBA, name: "TSX", mode: AddressingMode::Implied,     cycles: 2, handler: unimplemented,  illegal: false  },
    Instruction { opcode: 0xBB, name: "", mode: AddressingMode::Implied,        cycles: 2, handler: unimplemented,  illegal: true   },
    Instruction { opcode: 0xBC, name: "LDY", mode: AddressingMode::AbsoluteX,   cycles: 2, handler: unimplemented,  illegal: false  },
    Instruction { opcode: 0xBD, name: "LDA", mode: AddressingMode::AbsoluteX,   cycles: 2, handler: unimplemented,  illegal: false  },
    ...
    Instruction { opcode: 0xC0, name: "CPY", mode: AddressingMode::Immediate,   cycles: 2, handler: unimplemented,  illegal: false  },
    ...
    Instruction { opcode: 0xC4, name: "CPY", mode: AddressingMode::ZeroPage,    cycles: 2, handler: unimplemented,  illegal: false  },
    ...
    Instruction { opcode: 0xC8, name: "INY", mode: AddressingMode::Implied,     cycles: 2, handler: unimplemented,  illegal: false  },
    Instruction { opcode: 0xC9, name: "CMP", mode: AddressingMode::Immediate,   cycles: 2, handler: cmp,            illegal: false  },
    Instruction { opcode: 0xCA, name: "DEC", mode: AddressingMode::Implied,     cycles: 2, handler: unimplemented,  illegal: false  },
    Instruction { opcode: 0xCB, name: "", mode: AddressingMode::Implied,        cycles: 2, handler: unimplemented,  illegal: true   },
    Instruction { opcode: 0xCC, name: "CPY", mode: AddressingMode::Absolute,    cycles: 2, handler: unimplemented,  illegal: false  },
    ...
    Instruction { opcode: 0xE0, name: "CPX", mode: AddressingMode::Immediate,   cycles: 2, handler: unimplemented,  illegal: false  },
    Instruction { opcode: 0xE1, name: "SBC", mode: AddressingMode::IndirectX,   cycles: 2, handler: unimplemented,  illegal: false  },
    ...
    Instruction { opcode: 0xE4, name: "CPX", mode: AddressingMode::ZeroPage,    cycles: 2, handler: unimplemented,  illegal: false  },
    Instruction { opcode: 0xE5, name: "SBC", mode: AddressingMode::ZeroPage,    cycles: 2, handler: unimplemented,  illegal: false  },
    ...
    Instruction { opcode: 0xE9, name: "SBC", mode: AddressingMode::Immediate,   cycles: 2, handler: unimplemented,  illegal: false  },
    ...
    Instruction { opcode: 0xEC, name: "CPX", mode: AddressingMode::Absolute,    cycles: 2, handler: unimplemented,  illegal: false  },
    Instruction { opcode: 0xED, name: "SBC", mode: AddressingMode::Absolute,    cycles: 2, handler: unimplemented,  illegal: false  },
    ...
    Instruction { opcode: 0xF1, name: "SBC", mode: AddressingMode::IndirectY,   cycles: 2, handler: unimplemented,  illegal: false  },
    ...
    Instruction { opcode: 0xF5, name: "SBC", mode: AddressingMode::ZeroPageX,   cycles: 2, handler: unimplemented,  illegal: false  },
    ...
    Instruction { opcode: 0xF9, name: "SBC", mode: AddressingMode::AbsoluteY,   cycles: 2, handler: unimplemented,  illegal: false  },
    ...
    Instruction { opcode: 0xFD, name: "SBC", mode: AddressingMode::AbsoluteX,   cycles: 2, handler: unimplemented,  illegal: false  },
...
fn adc (cpu: &mut Cpu, operand: Operand, memory: &mut Memory) {
    ...
    let (res, carry) = cpu.a.overflowing_add(value + cpu.get_flag(StatusFlag::Carry) as u8);
    let (_, overflow) = (cpu.a as i8).overflowing_add(value as i8 + cpu.get_flag(StatusFlag::Carry) as i8);
    cpu.a = res;

    cpu.set_flag(StatusFlag::Carry, carry);
    cpu.set_flag(StatusFlag::Zero, res == 0);
    cpu.set_flag(StatusFlag::Overflow, overflow);
    cpu.set_flag(StatusFlag::Negative, (res as i8) < 0);
}
...
fn lsr (cpu: &mut Cpu, operand: Operand, memory: &mut Memory) {
    ...
    cpu.set_flag(StatusFlag::Carry, (value | 1) != 0);
    cpu.set_flag(StatusFlag::Zero, value == 0);
...
fn rts (cpu: &mut Cpu, operand: Operand, memory: &mut Memory) {
    ...
    let (hi, lo) = (cpu.pop_stack(memory), cpu.pop_stack(memory));
